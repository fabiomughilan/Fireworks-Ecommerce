...
const Dashboard = () => {
    ...
    const handleChangeCategory = (event) => {
        ...
        if (event.target.value !== "all") {
            ...
            fetchDataFromApi(`/api/products/catId?catId=${event.target.value}`).then((res) => {
                setProductList(res);
                context.setProgress(100);
            })
        }
                ...
                <div className="row dashboardBoxWrapperRow dashboard_Box dashboardBoxWrapperRowV2">
                    ...
                    <div className="col-md-4 pl-0 d-none">
                        <div className="box graphBox">
                            ...
                            <h3 className="text-white font-weight-bold">{totalSales?.toLocaleString('en-US', { style: 'currency', currency: 'INR' })}</h3>
