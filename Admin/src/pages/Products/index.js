...
const Products = () => {
  ...
  useEffect(() => {
    ...
    fetchDataFromApi("/api/products?page=1&perPage=8").then(
      (res) => {
        setProductList(res);
  ...
  const deleteProduct = (id) => {
    context.setProgress(40);
      ...
      deleteData(`/api/products/${id}`).then((res) => {
        ...
        fetchDataFromApi(
          `/api/products?page=${page}&perPage=8`
        ).then((res) => {
          setProductList(res);
        });
  ...
  const handleChange = (event, value) => {
    context.setProgress(40);
    setPage(value);
    fetchDataFromApi(`/api/products?page=${value}&perPage=8`).then(
      (res) => {
        setProductList(res);
        context.setProgress(100);
        window.scrollTo({
  ...
  const handleChangeCategory = (event) => {
    if (event.target.value !== "all") {
      ...
      fetchDataFromApi(
        `/api/products/catId?catId=${event.target.value}`
      ).then((res) => {
        setProductList(res);
        context.setProgress(100);
      });
      ...
      <div className="right-content w-100">
        <div className="card shadow border-0 w-100 flex-row p-4 align-items-center">
          ...
          <div className="ml-auto d-flex align-items-center">
            ...
            <Link to="/product/upload" exact={true.toString()}>
        ...
        <div className="card shadow border-0 p-3 mt-4">
          ...
          <div className="table-responsive mt-3">
            <table className="table table-bordered table-striped v-align">
              ...
              <tbody>
                {
                  productList?.products?.length !== 0 && productList?.products?.slice(0)
