...
const ProductUpload = () => {
    ...
    const removeImg = async (index, imgUrl) => {
        ...
        if (imgIndex > -1) { // only splice array when item is found
            previews.slice(index, 1); // 2nd parameter means remove one item only
        }
                ...
                <form className='form' onSubmit={addProduct} >
                    ...
                    <div className='card p-4 mt-0'>
                        <div className="imagesUploadSec">
                            ...
                            ><span><FaCloudUploadAlt /> &nbsp;  {isLoading === true ? <CircularProgress color="inherit" className="loader" /> : 'PUBLISH AND VIEW'} </span></Button>
                        </div>
                    </div>
                </form>
